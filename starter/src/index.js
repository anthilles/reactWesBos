...
render(<App/>, document.querySelector('#main')); //moduł w którym określamy element zwracany oraz element gdzie jest on zwracany. <StorePicker/> = <StorePicker></StorePicker>